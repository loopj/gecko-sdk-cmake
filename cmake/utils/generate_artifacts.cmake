...
function(gecko_sdk_generate_bin TARGET)
  add_custom_command(
    TARGET ${TARGET}
    POST_BUILD
...
function(gecko_sdk_generate_hex TARGET)
  add_custom_command(
    TARGET ${TARGET}
    POST_BUILD
    COMMAND ${CMAKE_OBJCOPY}
...
function(gecko_sdk_generate_s37 TARGET)
  add_custom_command(
    TARGET ${TARGET}
    POST_BUILD
    COMMAND ${CMAKE_OBJCOPY}
...
function(gecko_sdk_generate_gbl TARGET)
